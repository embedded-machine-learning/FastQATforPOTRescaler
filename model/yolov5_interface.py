...
class ConvQAT(nn.Module):
    ...
    def __init__(self, c1, c2, k=1, s=1, p=None, g=1, act=True):  # ch_in, ch_out, kernel, stride, padding, groups
        super().__init__()
        self.conv = Conv2dQuant(c1, c2, k, s, autopad(k, p), groups=g, bias=False,weight_quant_bits=32,weight_quant_channel_wise=True)
        self.bn = BatchNorm2dBase(c2,outQuantDyn=True,outQuantBits=32)
