    ...
    def int_extract(self, type_small=torch.int8, type_big=torch.int32) -> ResidualBlock_int:
        ...
        return ResidualBlock_int(
            block1=ConvBnA_int(
                ...
                self.conv1.dilation,
                self.conv1.groups,
                self.conv1.quant_weight.type(type_big),
                self.bn1.n.type(type_big),
                self.bn1.t.type(type_big),
                self.act1.min.type(type_big),
                self.act1.max.type(type_big),
            ),
            block2=ConvBnA_int(
                ...
                self.conv2.dilation,
                self.conv2.groups,
                self.conv2.quant_weight.type(type_big),
                self.bn2.n.type(type_big),
                self.bn2.t.type(type_big),
                self.act2.min.type(type_big),
                self.act2.max.type(type_big),
            ),
            down_sample_block=None,  # downsample not implemented
            add=Add_int(
                a_shift=self.add.a_shift.type(type_big),
                b_shift=self.add.b_shift.type(type_big),
                Act_min=self.act3.min.type(type_big),
                Act_max=self.act3.max.type(type_big),
            ),
        )
